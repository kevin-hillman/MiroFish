"""
Aktionsprotokollrecorder
Zum Aufzeichnen der Aktionen jedes Agents in der OASIS-Simulation, fuer Backend-Monitoring
...
class PlatformActionLogger:
    """Einzelplattform-Aktionsprotokollrecorder"""
    
    def __init__(self, platform: str, base_dir: str):
        """
        Protokollrecorder initialisieren
...
class SimulationLogManager:
    """
    Simulationsprotokollmanager
    Alle Protokolldateien einheitlich verwalten, nach Plattform getrennt
    """
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Twitter-Plattform-Protokollrecorder abrufen"""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Reddit-Plattform-Protokollrecorder abrufen"""
...
# ============ Kompatibilitaet mit alter Schnittstelle ============

class ActionLogger:
    """
    Aktionsprotokollrecorder (Kompatibilitaet mit alter Schnittstelle)
    Empfohlen wird die Verwendung von SimulationLogManager als Ersatz
    """
...
# Globale Protokollinstanz (Kompatibilitaet mit alter Schnittstelle)
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Globale Protokollinstanz abrufen (Kompatibilitaet mit alter Schnittstelle)"""
